...
// Remove the option we don't want to display in help
  ...
  llvm::cl::opt<std::string> inputIRfile(
      ...
      llvm::cl::desc("<input preprocessed IR file>"));
  llvm::cl::opt<std::string> mutantInfoJsonfile(
      "mutant-infos", llvm::cl::Required,
      llvm::cl::desc("(required) Specify the mutants info JSON file"),
      llvm::cl::value_desc("filename"));
  llvm::cl::opt<std::string> martOutTopDir(
      "out-topdir", llvm::cl::Required,
      llvm::cl::desc("(required) Specify output topdir where the selection "
                     "output forlder will be created"),
