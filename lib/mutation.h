...
class Mutation
{
    ...
    const char * wmLogFuncName = "martLLVM_WM_Log__Function"; //This fuction take the mutant ID and the condition and print the mutant ID if the condition is true.
    const char * wmFFlushFuncName = "martLLVM_WM_Log__Function_Explicit_FFlush"; //This fuction flushes the logged mutant to file(call this before actual execution of the statement).
