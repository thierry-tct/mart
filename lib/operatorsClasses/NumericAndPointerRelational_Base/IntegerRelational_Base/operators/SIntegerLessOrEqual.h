#ifndef __MART_SEMU_GENMU_operatorClasses__SIntegerLessOrEqual__
#define __MART_SEMU_GENMU_operatorClasses__SIntegerLessOrEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__SIntegerLessOrEqual__
