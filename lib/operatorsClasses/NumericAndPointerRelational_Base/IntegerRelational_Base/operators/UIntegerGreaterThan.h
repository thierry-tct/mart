#ifndef __MART_SEMU_GENMU_operatorClasses__UIntegerGreaterThan__
#define __MART_SEMU_GENMU_operatorClasses__UIntegerGreaterThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__UIntegerGreaterThan__
