#ifndef __MART_SEMU_GENMU_operatorClasses__IntegerEqual__
#define __MART_SEMU_GENMU_operatorClasses__IntegerEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__IntegerEqual__
