#ifndef __MART_SEMU_GENMU_operatorClasses__SIntegerGreaterOrEqual__
#define __MART_SEMU_GENMU_operatorClasses__SIntegerGreaterOrEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__SIntegerGreaterOrEqual__
