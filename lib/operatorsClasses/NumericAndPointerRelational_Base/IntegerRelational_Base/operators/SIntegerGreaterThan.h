#ifndef __MART_SEMU_GENMU_operatorClasses__SIntegerGreaterThan__
#define __MART_SEMU_GENMU_operatorClasses__SIntegerGreaterThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__SIntegerGreaterThan__
