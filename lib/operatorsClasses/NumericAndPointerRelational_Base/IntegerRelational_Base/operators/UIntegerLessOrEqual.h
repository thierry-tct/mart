#ifndef __MART_SEMU_GENMU_operatorClasses__UIntegerLessOrEqual__
#define __MART_SEMU_GENMU_operatorClasses__UIntegerLessOrEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__UIntegerLessOrEqual__
