#ifndef __MART_SEMU_GENMU_operatorClasses__PointerNotEqual__
#define __MART_SEMU_GENMU_operatorClasses__PointerNotEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PointerNotEqual__
