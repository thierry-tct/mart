#ifndef __MART_SEMU_GENMU_operatorClasses__PointerGreaterThan__
#define __MART_SEMU_GENMU_operatorClasses__PointerGreaterThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PointerGreaterThan__
