#ifndef __MART_SEMU_GENMU_operatorClasses__PointerGreaterOrEqual__
#define __MART_SEMU_GENMU_operatorClasses__PointerGreaterOrEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PointerGreaterOrEqual__
