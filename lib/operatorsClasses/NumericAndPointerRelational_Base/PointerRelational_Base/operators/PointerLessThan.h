#ifndef __MART_SEMU_GENMU_operatorClasses__PointerLessThan__
#define __MART_SEMU_GENMU_operatorClasses__PointerLessThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PointerLessThan__
