#ifndef __MART_SEMU_GENMU_operatorClasses__UFPGreaterThan__
#define __MART_SEMU_GENMU_operatorClasses__UFPGreaterThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__UFPGreaterThan__
