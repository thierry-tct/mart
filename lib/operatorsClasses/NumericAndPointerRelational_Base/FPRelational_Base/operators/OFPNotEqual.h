#ifndef __MART_SEMU_GENMU_operatorClasses__OFPNotEqual__
#define __MART_SEMU_GENMU_operatorClasses__OFPNotEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__OFPNotEqual__
