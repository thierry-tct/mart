#ifndef __MART_SEMU_GENMU_operatorClasses__UFPLessThan__
#define __MART_SEMU_GENMU_operatorClasses__UFPLessThan__
...
#endif //__MART_SEMU_GENMU_operatorClasses__UFPLessThan__
