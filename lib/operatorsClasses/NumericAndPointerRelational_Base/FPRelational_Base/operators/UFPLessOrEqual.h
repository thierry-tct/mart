#ifndef __MART_SEMU_GENMU_operatorClasses__UFPLessOrEqual__
#define __MART_SEMU_GENMU_operatorClasses__UFPLessOrEqual__
...
#endif //__MART_SEMU_GENMU_operatorClasses__UFPLessOrEqual__
