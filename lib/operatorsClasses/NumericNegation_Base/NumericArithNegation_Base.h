#ifndef __MART_SEMU_GENMU_operatorClasses__NumericArithNegation_Base__
#define __MART_SEMU_GENMU_operatorClasses__NumericArithNegation_Base__
...
#endif //__MART_SEMU_GENMU_operatorClasses__NumericArithNegation_Base__
