#ifndef __MART_SEMU_GENMU_operatorClasses__FPMinus__
#define __MART_SEMU_GENMU_operatorClasses__FPMinus__
...
#endif //__MART_SEMU_GENMU_operatorClasses__FPMinus__
