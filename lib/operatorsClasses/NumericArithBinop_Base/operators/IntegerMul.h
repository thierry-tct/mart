#ifndef __MART_SEMU_GENMU_operatorClasses__IntegerMul__
#define __MART_SEMU_GENMU_operatorClasses__IntegerMul__
...
#endif //__MART_SEMU_GENMU_operatorClasses__IntegerMul__
