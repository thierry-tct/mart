#ifndef __KLEE_SEMU_GENMU_operatorClasses__IntegerMul__
#define __KLEE_SEMU_GENMU_operatorClasses__IntegerMul__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__IntegerMul__
