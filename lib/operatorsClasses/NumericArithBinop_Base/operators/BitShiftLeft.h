#ifndef __KLEE_SEMU_GENMU_operatorClasses__BitShiftLeft__
#define __KLEE_SEMU_GENMU_operatorClasses__BitShiftLeft__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__BitShiftLeft__
