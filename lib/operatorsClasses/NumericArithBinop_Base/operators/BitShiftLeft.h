#ifndef __MART_SEMU_GENMU_operatorClasses__BitShiftLeft__
#define __MART_SEMU_GENMU_operatorClasses__BitShiftLeft__
...
#endif //__MART_SEMU_GENMU_operatorClasses__BitShiftLeft__
