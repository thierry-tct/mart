#ifndef __MART_SEMU_GENMU_operatorClasses__IntegerAdd__
#define __MART_SEMU_GENMU_operatorClasses__IntegerAdd__
...
#endif //__MART_SEMU_GENMU_operatorClasses__IntegerAdd__
