#ifndef __KLEE_SEMU_GENMU_operatorClasses__FPAbs__
#define __KLEE_SEMU_GENMU_operatorClasses__FPAbs__
 ...
 *  
 * \brief    Class for replacing a numeric Floating Point expresion with absolute value
 */
...
class FPAbs: public ReplaceOnly_Base
{
    ...
    llvm::Value * createReplacement (llvm::Value * oprd1_addrOprd, llvm::Value * oprd2_intValOprd, std::vector<llvm::Value *> &replacement, ModuleUserInfos const &MI)
    {
        ...
        llvm::Value *fminusVal = builder.CreateFSub(llvm::ConstantFP::get(oprd1_addrOprd->getType(), 0.0), oprd1_addrOprd);
        llvm::Value *fcmp = builder.CreateFCmp(llvm::CmpInst::FCMP_UGE, oprd1_addrOprd, llvm::ConstantFP::get(oprd1_addrOprd->getType(), 0.0));
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__FPAbs__
