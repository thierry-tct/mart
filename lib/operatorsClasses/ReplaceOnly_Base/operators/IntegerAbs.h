#ifndef __KLEE_SEMU_GENMU_operatorClasses__IntegerAbs__
#define __KLEE_SEMU_GENMU_operatorClasses__IntegerAbs__
...
class IntegerAbs: public ReplaceOnly_Base
{
    ...
    llvm::Value * createReplacement (llvm::Value * oprd1_addrOprd, llvm::Value * oprd2_intValOprd, std::vector<llvm::Value *> &replacement, ModuleUserInfos const &MI)
    {
        ...
        llvm::Value *minusVal = builder.CreateSub(llvm::ConstantInt::get(oprd1_addrOprd->getType(), 0), oprd1_addrOprd);
        llvm::Value *cmp = builder.CreateICmp(llvm::CmpInst::ICMP_SGE, oprd1_addrOprd, llvm::ConstantInt::get(oprd1_addrOprd->getType(), 0));
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__IntegerAbs__
