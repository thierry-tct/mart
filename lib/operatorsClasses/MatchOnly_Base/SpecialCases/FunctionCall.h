#ifndef __MART_SEMU_GENMU_operatorClasses__FunctionCall__
#define __MART_SEMU_GENMU_operatorClasses__FunctionCall__
...
#endif //__MART_SEMU_GENMU_operatorClasses__FunctionCall__
