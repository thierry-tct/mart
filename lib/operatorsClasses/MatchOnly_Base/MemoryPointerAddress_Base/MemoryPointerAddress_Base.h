#ifndef __MART_SEMU_GENMU_operatorClasses__MemoryPointerAddress_Base__
#define __MART_SEMU_GENMU_operatorClasses__MemoryPointerAddress_Base__
...
#endif //__MART_SEMU_GENMU_operatorClasses__MemoryPointerAddress_Base__
