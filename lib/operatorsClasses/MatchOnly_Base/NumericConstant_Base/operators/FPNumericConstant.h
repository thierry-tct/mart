#ifndef __KLEE_SEMU_GENMU_operatorClasses__FPNumericConstant__
#define __KLEE_SEMU_GENMU_operatorClasses__FPNumericConstant__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__FPNumericConstant__
