#ifndef __MART_SEMU_GENMU_operatorClasses__NumericVariable_Base__
#define __MART_SEMU_GENMU_operatorClasses__NumericVariable_Base__
...
#endif //__MART_SEMU_GENMU_operatorClasses__NumericVariable_Base__
