#ifndef __MART_GENMU_operatorClasses__PointerLeftDec__
#define __MART_GENMU_operatorClasses__PointerLeftDec__
...
#endif //__MART_GENMU_operatorClasses__PointerLeftDec__
