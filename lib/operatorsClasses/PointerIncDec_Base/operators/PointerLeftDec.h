#ifndef __MART_SEMU_GENMU_operatorClasses__PointerLeftDec__
#define __MART_SEMU_GENMU_operatorClasses__PointerLeftDec__
...
}; // class PointerLeftDec

} // namespace mart

#endif //__MART_SEMU_GENMU_operatorClasses__PointerLeftDec__
