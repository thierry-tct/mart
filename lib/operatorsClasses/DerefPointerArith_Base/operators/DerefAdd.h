#ifndef __KLEE_SEMU_GENMU_operatorClasses__DerefAdd__
#define __KLEE_SEMU_GENMU_operatorClasses__DerefAdd__
...
class DerefAdd: public DerefPointerArith_Base
{
  protected:
    /**
    ...
    {
        tmpMutationOp.setMatchOp_CP(getCorrespondingAritPtrOp(), std::vector<enum codeParts>({cpEXPR, mutationOp.getCPType(1)}));
    }
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__DerefAdd__
