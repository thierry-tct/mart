#ifndef __MART_GENMU_operatorClasses__PSubDerefPtr__
#define __MART_GENMU_operatorClasses__PSubDerefPtr__
...
#endif //__MART_GENMU_operatorClasses__PSubDerefPtr__
