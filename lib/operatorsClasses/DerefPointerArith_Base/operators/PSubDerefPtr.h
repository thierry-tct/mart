#ifndef __MART_SEMU_GENMU_operatorClasses__PSubDerefPtr__
#define __MART_SEMU_GENMU_operatorClasses__PSubDerefPtr__
...
class PSubDerefPtr : public DerefPointerArith_Base {
protected:
  /**
...
#endif //__MART_SEMU_GENMU_operatorClasses__PSubDerefPtr__
