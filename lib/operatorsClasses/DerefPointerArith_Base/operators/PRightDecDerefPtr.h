#ifndef __MART_GENMU_operatorClasses__PRightDecDerefPtr__
#define __MART_GENMU_operatorClasses__PRightDecDerefPtr__
...
#endif //__MART_GENMU_operatorClasses__PRightDecDerefPtr__
