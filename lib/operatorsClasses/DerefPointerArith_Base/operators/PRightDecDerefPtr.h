#ifndef __KLEE_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
#define __KLEE_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
