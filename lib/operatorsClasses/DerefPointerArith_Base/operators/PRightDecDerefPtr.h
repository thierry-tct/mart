#ifndef __MART_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
#define __MART_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
...
class PRightDecDerefPtr : public DerefPointerArith_Base {
protected:
  /**
...
}; // class PRightDecDerefPtr

} // namespace mart

#endif //__MART_SEMU_GENMU_operatorClasses__PRightDecDerefPtr__
