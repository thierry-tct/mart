#ifndef __MART_SEMU_GENMU_operatorClasses__DerefPAdd__
#define __MART_SEMU_GENMU_operatorClasses__DerefPAdd__
...
#endif //__MART_SEMU_GENMU_operatorClasses__DerefPAdd__
