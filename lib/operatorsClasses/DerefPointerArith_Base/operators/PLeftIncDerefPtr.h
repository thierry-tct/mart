#ifndef __MART_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
#define __MART_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
