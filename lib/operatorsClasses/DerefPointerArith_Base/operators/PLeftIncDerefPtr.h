#ifndef __KLEE_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
#define __KLEE_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
...
class PLeftIncDerefPtr : public DerefPointerArith_Base {
protected:
  /**
...
}; // class PLeftIncDerefPtr

} // namespace mart

#endif //__KLEE_SEMU_GENMU_operatorClasses__PLeftIncDerefPtr__
