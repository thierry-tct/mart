#ifndef __MART_GENMU_operatorClasses__PLeftIncDerefPtr__
#define __MART_GENMU_operatorClasses__PLeftIncDerefPtr__
...
#endif //__MART_GENMU_operatorClasses__PLeftIncDerefPtr__
