#ifndef __KLEE_SEMU_GENMU_operatorClasses__PRightIncDerefPtr__
#define __KLEE_SEMU_GENMU_operatorClasses__PRightIncDerefPtr__
...
class PRightIncDerefPtr : public DerefPointerArith_Base {
protected:
  /**
...
}; // class PRightIncDerefPtr

} // namespace mart

#endif //__KLEE_SEMU_GENMU_operatorClasses__PRightIncDerefPtr__
