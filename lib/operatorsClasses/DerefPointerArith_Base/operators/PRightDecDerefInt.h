#ifndef __MART_GENMU_operatorClasses__PRightDecDerefInt__
#define __MART_GENMU_operatorClasses__PRightDecDerefInt__
...
#endif //__MART_GENMU_operatorClasses__PRightDecDerefInt__
