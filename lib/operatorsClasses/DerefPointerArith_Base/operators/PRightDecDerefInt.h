#ifndef __MART_SEMU_GENMU_operatorClasses__PRightDecDerefInt__
#define __MART_SEMU_GENMU_operatorClasses__PRightDecDerefInt__
...
class PRightDecDerefInt : public DerefPointerArith_Base {
protected:
  /**
...
}; // class PRightDecDerefInt

} // namespace mart

#endif //__MART_SEMU_GENMU_operatorClasses__PRightDecDerefInt__
