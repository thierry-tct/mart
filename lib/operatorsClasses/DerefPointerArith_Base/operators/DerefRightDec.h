#ifndef __KLEE_SEMU_GENMU_operatorClasses__DerefRightDec__
#define __KLEE_SEMU_GENMU_operatorClasses__DerefRightDec__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__DerefRightDec__
