#ifndef __MART_SEMU_GENMU_operatorClasses__PLeftDecDerefInt__
#define __MART_SEMU_GENMU_operatorClasses__PLeftDecDerefInt__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PLeftDecDerefInt__
