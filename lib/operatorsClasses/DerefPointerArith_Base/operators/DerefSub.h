#ifndef __MART_SEMU_GENMU_operatorClasses__DerefSub__
#define __MART_SEMU_GENMU_operatorClasses__DerefSub__
...
#endif //__MART_SEMU_GENMU_operatorClasses__DerefSub__
