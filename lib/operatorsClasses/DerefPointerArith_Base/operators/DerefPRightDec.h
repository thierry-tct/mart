#ifndef __KLEE_SEMU_GENMU_operatorClasses__DerefPRightDec__
#define __KLEE_SEMU_GENMU_operatorClasses__DerefPRightDec__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__DerefPRightDec__
