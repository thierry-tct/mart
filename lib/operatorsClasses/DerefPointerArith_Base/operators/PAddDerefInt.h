#ifndef __KLEE_SEMU_GENMU_operatorClasses__PAddDerefInt__
#define __KLEE_SEMU_GENMU_operatorClasses__PAddDerefInt__
...
class PAddDerefInt: public DerefPointerArith_Base
{
  protected:
    /**
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__PAddDerefInt__
