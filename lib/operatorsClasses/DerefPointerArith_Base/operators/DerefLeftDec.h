#ifndef __MART_GENMU_operatorClasses__DerefLeftDec__
#define __MART_GENMU_operatorClasses__DerefLeftDec__
...
#endif //__MART_GENMU_operatorClasses__DerefLeftDec__
