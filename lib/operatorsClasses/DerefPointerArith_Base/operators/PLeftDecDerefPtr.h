#ifndef __MART_GENMU_operatorClasses__PLeftDecDerefPtr__
#define __MART_GENMU_operatorClasses__PLeftDecDerefPtr__
...
#endif //__MART_GENMU_operatorClasses__PLeftDecDerefPtr__
