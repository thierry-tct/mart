#ifndef __KLEE_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
#define __KLEE_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
...
class PLeftDecDerefPtr : public DerefPointerArith_Base {
protected:
  /**
...
}; // class PLeftDecDerefPtr

} // namespace mart

#endif //__KLEE_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
