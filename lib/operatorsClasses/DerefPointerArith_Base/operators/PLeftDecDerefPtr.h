#ifndef __MART_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
#define __MART_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
...
#endif //__MART_SEMU_GENMU_operatorClasses__PLeftDecDerefPtr__
