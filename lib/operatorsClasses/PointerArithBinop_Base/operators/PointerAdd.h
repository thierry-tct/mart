#ifndef __KLEE_SEMU_GENMU_operatorClasses__PointerAdd__
#define __KLEE_SEMU_GENMU_operatorClasses__PointerAdd__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__PointerAdd__
