#ifndef __KLEE_SEMU_GENMU_operatorClasses__IntegerRightDec__
#define __KLEE_SEMU_GENMU_operatorClasses__IntegerRightDec__
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__IntegerRightDec__
