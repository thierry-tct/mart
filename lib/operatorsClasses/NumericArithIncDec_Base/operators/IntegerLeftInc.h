#ifndef __KLEE_SEMU_GENMU_operatorClasses__IntegerLeftInc__
#define __KLEE_SEMU_GENMU_operatorClasses__IntegerLeftInc__
 ...
 *
 * \brief     Generic abstract base class for all non-pointer arithmetic left
...
class IntegerLeftInc : public NumericArithIncDec_Base {
protected:
  /**
...
}; // class IntegerLeftInc

} // namespace mart

#endif //__KLEE_SEMU_GENMU_operatorClasses__IntegerLeftInc__
