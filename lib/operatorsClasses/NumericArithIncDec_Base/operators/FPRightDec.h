#ifndef __KLEE_SEMU_GENMU_operatorClasses__FPRightDec__
#define __KLEE_SEMU_GENMU_operatorClasses__FPRightDec__
 ...
 *  
 * \brief     Generic abstract base class for all non-pointer arithmetic FP right decrement mutation operator.
 * \details   This abstract class define is extended from the Generic base class. 
 */
 
#include "../NumericArithIncDec_Base.h"

class FPRightDec: public NumericArithIncDec_Base
{
    protected:
    /**
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__FPRightDec__
