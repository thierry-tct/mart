#ifndef __MART_SEMU_GENMU_operatorClasses__FPLeftInc__
#define __MART_SEMU_GENMU_operatorClasses__FPLeftInc__
...
#endif //__MART_SEMU_GENMU_operatorClasses__FPLeftInc__
