#ifndef __KLEE_SEMU_GENMU_operatorClasses__IntegerRightInc__
#define __KLEE_SEMU_GENMU_operatorClasses__IntegerRightInc__
 ...
 *  
 * \brief     Generic abstract base class for all non-pointer arithmetic right increment mutation operator.
 * \details   This abstract class define is extended from the Generic base class. 
 */
 
#include "../NumericArithIncDec_Base.h"

class IntegerRightInc: public NumericArithIncDec_Base
{
    protected:
    /**
...
#endif //__KLEE_SEMU_GENMU_operatorClasses__IntegerRightInc__
